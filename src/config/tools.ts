...
export const tools: Tool[] = [
  ...
  // ==================== GIF TOOLS ====================
  {
    ...
    icon: 'film',
    category: 'gif-tools',
    acceptedFormats: ['.jpg', '.jpeg', '.png', '.webp', '.bmp', '.gif', '.apng', '.avif', '.jxl', '.svg'],
    outputFormat: 'gif',
    maxFileSize: Infinity,
    maxFiles: 200,
    features: ['multiple-images', 'frame-delay', 'loop', 'resize', 'reorder', 'preview'],
  ...
  },
  {
    ...
    maxFileSize: Infinity,
    maxFiles: 1,
    features: ['trim', 'resize', 'frame-rate', 'quality', 'loop', 'preview'],
    relatedTools: ['gif-maker', 'gif-to-mp4', 'mp4-to-gif'],
  },
  {
    id: 'gif-to-mp4',
    slug: 'gif-to-mp4',
    ...
    maxFileSize: Infinity,
    maxFiles: 1,
    features: ['lossless', 'quality', 'resize', 'preview'],
    relatedTools: ['gif-maker', 'video-to-gif', 'gif-to-webm'],
  },
  {
    id: 'gif-to-webm',
    slug: 'gif-to-webm',
    ...
    maxFileSize: Infinity,
    maxFiles: 1,
    features: ['quality', 'resize', 'preview'],
    relatedTools: ['gif-to-mp4', 'gif-to-mov', 'gif-maker'],
  },
  {
    id: 'gif-to-mov',
    slug: 'gif-to-mov',
    ...
    maxFiles: 1,
    features: ['quality', 'resize', 'preview'],
    relatedTools: ['gif-to-mp4', 'gif-to-mkv', 'gif-maker'],
  },
  {
    id: 'webp-to-gif',
    slug: 'webp-to-gif',
    ...
    maxFileSize: Infinity,
    maxFiles: 1,
    features: ['animated-webp', 'quality', 'resize', 'preview'],
    relatedTools: ['gif-maker', 'apng-to-gif', 'gif-to-mp4'],
  },
  {
    id: 'apng-to-gif',
    slug: 'apng-to-gif',
    icon: 'film',
    category: 'gif-tools',
    acceptedFormats: ['.apng', '.png'],
    outputFormat: 'gif',
    maxFileSize: Infinity,
    maxFiles: 1,
    features: ['animated-png', 'quality', 'resize', 'preview'],
    relatedTools: ['gif-maker', 'webp-to-gif', 'gif-to-mp4'],
  },
  {
    id: 'avif-to-gif',
    slug: 'avif-to-gif',
    ...
    maxFileSize: Infinity,
    maxFiles: 1,
    features: ['animated-avif', 'quality', 'resize', 'preview'],
    relatedTools: ['gif-maker', 'webp-to-gif', 'apng-to-gif'],
  },
  {
    id: 'jxl-to-gif',
    slug: 'jxl-to-gif',
    ...
    maxFileSize: Infinity,
    maxFiles: 1,
    features: ['animated-jxl', 'quality', 'resize', 'preview'],
    relatedTools: ['gif-maker', 'avif-to-gif', 'webp-to-gif'],
  },
  {
    id: 'svg-to-gif',
    slug: 'svg-to-gif',
    ...
    maxFileSize: Infinity,
    maxFiles: 1,
    features: ['animated-svg', 'quality', 'resize', 'preview'],
    relatedTools: ['gif-maker', 'webp-to-gif', 'gif-to-mp4'],
  },
  {
    id: 'gif-analyzer',
    ...
    maxFileSize: Infinity,
    maxFiles: 1,
    features: ['frame-count', 'dimensions', 'duration', 'color-palette', 'frame-preview'],
    relatedTools: ['gif-maker', 'gif-to-mp4', 'video-to-gif'],
  },
];
